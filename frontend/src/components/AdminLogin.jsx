        ...
        try {
            ...
            if(auth.token){
                ...
                setTimeout(()=>{
                    ...
                    alert('Token has been expired!, Please login agian.');
                    navigate("/")
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                 ...
                 leading-tight focus:outline-none focus:shadow' />
                    ...
                    <div className='w-full'>
                        <button className='bg-blue-500 w-full hover:bg-blue-700 text-white font-bold mt-4 py-2 px-8 rounded focus:outline-none'>Login</button>
                    </div>
                </form>
